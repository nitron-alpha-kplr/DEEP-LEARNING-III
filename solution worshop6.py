...
model = load_model('/home/ec2-user/CNN-CASE-STUDY/model.h5', custom_objects={'FixedDropout':FixedDropout(rate=0.4)})
...
#Try to fill the predict_label function , where we will load image , transform it to an array , reshape it and predict the class of the
image

def predict_label(img_path):

    i = #add image.load_img method and take as argument the image path and the target image size
(240,240)
...
zero.
            ...
            # Open a local file with w ( write binary ) permission.
